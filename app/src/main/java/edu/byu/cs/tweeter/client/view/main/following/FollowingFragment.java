...
public class FollowingFragment extends Fragment implements FollowingPresenter.View {
    ...
    private final FollowingPresenter followingPresenter = new FollowingPresenter(this);
    ...
    public static FollowingFragment newInstance(User user) {
        String METHOD_TAG = TAG + ".newInstance()";
        Log.i(METHOD_TAG, "called with user: " + user.toString());
        ...
        Log.i(METHOD_TAG, "call succeeded, returning fragment");
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String METHOD_TAG = TAG + ".onCreateView()";
        Log.i(METHOD_TAG, "called");
        View view = inflater.inflate(R.layout.fragment_following, container, false);

        followingPresenter.setUser((User) getArguments().getSerializable(USER_KEY));
        ...
        Log.i(METHOD_TAG, "call succeeded");
        return view;
    }
    ...
    private class FollowingHolder extends RecyclerView.ViewHolder {
        private final String SUB_TAG = TAG + ".FollowingHolder";
        ...
        FollowingHolder(@NonNull View itemView) {
            super(itemView);
            String METHOD_TAG = SUB_TAG + ".FollowingHolder()";
            Log.i(METHOD_TAG, "constructor entered");
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String SUB_METHOD_TAG = SUB_TAG + ".onClick(View view)";
                    followingPresenter.getUser(userAlias.getText().toString());
                    Log.i(SUB_METHOD_TAG, "method succeeded");
                    displayMessage("Getting user's profile...");
                }
            });
            Log.i(SUB_TAG, "construction succeeded");
        }
        ...
        void bindUser(User user) {
            String METHOD_TAG = SUB_TAG + ".bindUser()";
            Log.i(METHOD_TAG, "method called");
            userImage.setImageDrawable(ImageUtils.drawableFromByteArray(user.getImageBytes()));
            userAlias.setText(user.getAlias());
            userName.setText(user.getName());
            Log.i(METHOD_TAG, "method succeeded");
        }
    ...
    private class FollowingRecyclerViewAdapter extends RecyclerView.Adapter<FollowingHolder> {
        ...
        private final String SUB_TAG = TAG + ".FollowingRecyclerViewAdapter";
        ...
        FollowingRecyclerViewAdapter() {
            String METHOD_TAG = SUB_TAG + ".FollowingRecyclerViewAdapter()";
            Log.i(METHOD_TAG, "constructor called, calling " + METHOD_TAG + ".loadMoreItems()");
            loadMoreItems();
            Log.i(METHOD_TAG, "constructor finished");
        }
        ...
        void addItems(List<User> newUsers) {
            String METHOD_TAG = SUB_TAG + ".addItems()";
            Log.i(METHOD_TAG, "called with " + newUsers.size() + " new users");
        ...
        void addItem(User user) {
            String METHOD_TAG = SUB_TAG + ".addItem()";
            Log.i(METHOD_TAG, "method called with " + user.toString());
            users.add(user);
        ...
        void removeItem(User user) {
            String METHOD_TAG = SUB_TAG + ".removeItem()";
            Log.i(METHOD_TAG, "method called with " + user.toString());
        ...
        public void onBindViewHolder(@NonNull FollowingHolder followingHolder, int position) {
            String METHOD_TAG = SUB_TAG + ".onBindViewHolder()";
            Log.i(METHOD_TAG, "method called");
            if (!isLoading) {
                Log.i(METHOD_TAG, "isLoading == false");
                followingHolder.bindUser(users.get(position));
            } else {
                Log.i(METHOD_TAG, "isLoading == true");
            }
            Log.i(METHOD_TAG, "method finished");
        }
        ...
        public int getItemCount() {
            String METHOD_TAG = SUB_TAG + ".getItemCount()";
            Log.i(METHOD_TAG, "method returned " + users.size());
            return users.size();
        }
        ...
        public int getItemViewType(int position) {
            String METHOD_TAG = SUB_TAG + ".getItemViewType";
            Log.i(METHOD_TAG, "method returned " + ((position == users.size() - 1 && isLoading) ? LOADING_DATA_VIEW : ITEM_VIEW));
