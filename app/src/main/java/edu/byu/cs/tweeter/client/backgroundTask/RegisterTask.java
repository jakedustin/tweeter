...
public class RegisterTask implements Runnable {
    ...
    private Pair<User, AuthToken> doRegister() throws IOException, TweeterRemoteException {
        ...
        RegisterUserResponse registerUserResponse = serverFacade.register(registerUserRequest, "register");

        if (!registerUserResponse.isSuccess()) {
            sendFailedMessage(registerUserResponse.getMessage());
            return null;
        }

        User registeredUser = registerUserResponse.getUser();
        AuthToken authToken = registerUserResponse.getAuthToken();
